defmodule ClocksWeb.Router do
  ...
  pipeline :authenticated do
    plug ClocksWeb.Plugs.RequireAuth
  end
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {ClocksWeb.Layouts, :root}
  ...
  if Application.compile_env(:clocks, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ClocksWeb.Telemetry
